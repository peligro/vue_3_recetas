...
let enviar = async () => {
  ...
  try {
      let respuesta = await fetch(`${import.meta.env.VITE_API_URL}recetas/editar/foto`, {
        method: 'POST',
        body: formData,
            ...
            <Form @submit="enviar()">
              <div class="row">
                <div class="col-12 col-lg-12">
                 <img :src="datos.data?.imagen" alt="" style="width: 100px;" />
                </div>
                <div class="col-12 col-lg-12">
